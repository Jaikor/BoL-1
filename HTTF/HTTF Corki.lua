...
function CorkiMenu()
  ...
  Menu:addSubMenu("HitChance Settings", "HitChance")
    ...
    Menu.HitChance:addSubMenu("Harass", "Harass")
      Menu.HitChance.Harass:addParam("Q", "Q HitChacne (Default value = 2.03)", SCRIPT_PARAM_SLICE, 2.03, 1, 3, 2)
...
function CastQ(unit, mode)
  ...
  if unit.dead or mode ~= "JSteal" and mode ~= "KillSteal" and not OrbwalkCanMove() then
    return
  end
